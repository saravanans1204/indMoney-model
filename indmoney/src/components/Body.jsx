        ...
        <div className='body-main'>
            ...
            <div className='head'>
                    ...
                    <div className='first-section'>
                            <img style={{marginTop:'2vh'}} src={medium} alt='head'></img>
                            <span className='head-brands'>
                            <svg viewBox="0 0 64 64" width="23.25" height="23.35"><circle cx="32" cy="32" r="31" fill="#00aced">
                            </circle>
                    ...
                    <div className='head-sidebar'>
                        ...
                        <ul className='download'>
                            <h2>Download App</h2>
                            <div className='store'>
                                <p>Excellent on <span>Apple</span></p>
                            ...
                            <div className='store'>
                                <p>Excellent on <span>Android</span></p>
